function About() {
  ...
  <div >
    <div>
        <h1> Our Mission </h1>
        <p> The PlantFinder web-program aims to equip its users with the necessary plant information in order to empower them to 
            ...
            can have the tools at their disposal to build a flourishing garden.  </p>
        <h1> Our Story </h1>
        <p> The PlantFinder web-program was developed by a group of undergraduate Computer Science students at Hunter College in New York 
            ...
            of planting native species and mitigating the spread of invasive plants.  </p>
        <h1> Motivation </h1>
        <p> A history of environmental degradation and lack of environmental education has left many parts of the United States without strong, 
