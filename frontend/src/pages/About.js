...
function About() {
  ...
  <div >
    {/* <div>        
      ...
      <h1 className='hAbout' id="ourstory"> Our Story </h1>
    ...
    <div id="aboutpagecontainer">
      <div id="leftcontent">
        <img src="/bernd-dittrich.jpg" alt="a group of people with garden tools" id='aboutimg'/>
      </div>
      <div id="rightcontent">
          ...
          <button id="aboutbutton"><span class="material-symbols-outlined" id="arrow">arrow_forward</span></button>
      </div>
    </div>
    < Footer />
  </div>
